...
public class EmployeeJpaController implements Serializable {
        ...
        try {
            ...
            for (Bank bankListOldBank : bankListOld) {
                if (!bankListNew.contains(bankListOldBank)) {
                    ...
                    illegalOrphanMessages.add("You must retain Bank " + bankListOldBank + " since its employeeIdemployee field is not nullable.");
                }
            }
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            List<Bank> bankListOrphanCheck = employee.getBankList();
            for (Bank bankListOrphanCheckBank : bankListOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Employee (" + employee + ") cannot be destroyed since the Bank " + bankListOrphanCheckBank + " in its bankList field has a non-nullable employeeIdemployee field.");
            }
