...
public class JobJpaController implements Serializable {
    ...
    public void create(Job job) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public int getJobCount() {
     ...
     public List<Job> findJobByTitle(String title) {
        EntityManager em = getEntityManager();
        return em.createNamedQuery("Job.findByTitle").setParameter("title", "%" + title + "%").getResultList();
    }
}
