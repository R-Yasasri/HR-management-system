...
public class PerformanceFeedbackJpaController implements Serializable {
    ...
    public List<PerformanceFeedback> findPerformanceFeedbackByPersonGiven(String personGivenBy) {
        EntityManager em = getEntityManager();

        return em.createNamedQuery("PerformanceFeedback.findByPersonGivenBy").setParameter("personGivenBy", "%" + personGivenBy + "%").getResultList();
    }
