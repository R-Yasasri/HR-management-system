...
public class DisciplinaryHistoryJpaController implements Serializable {
    ...
    public int getDisciplinaryHistoryCount() {
        ...
        public List<DisciplinaryHistory> findDisciplinaryHistoryByActionTaken(String actionTaken) {
        EntityManager em = getEntityManager();
        return em.createNamedQuery("DisciplinaryHistory.findByActionTaken").setParameter("actionTaken", "%" + actionTaken + "%").getResultList();
    }
}
