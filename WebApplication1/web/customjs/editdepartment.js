...
//            alert(response);
    ...
    request.open("GET", "LoadDepartment", true);
    request.send();
}
...
//    alert(resp);
    ...
    table.innerHTML = "<thead><tr role='row'><th>ID</th><th>Name</th><th style='width: 50px;'></th></tr></thead>";
...
function remove(id) {
    ...
    if (option) {
        ...
        request.open("GET", "DeleteDepartment?id=" + id, true);
        request.send();
    }
}
...
function searchById() {
    ...
    request.open("GET", "SearchDepartmentById?id=" + search, true);
    request.send();
}
...
function search_two() {
    ...
    request.open("GET", "SearchDepartmentByName?name=" + search, true);
    request.send();
}
...
//    alert(id + name + birthday + nic + email + mobile + address);
    ...
    request.open("GET", "EditDepartment?id=" + id + "&name=" + name, true);
    request.send();
}