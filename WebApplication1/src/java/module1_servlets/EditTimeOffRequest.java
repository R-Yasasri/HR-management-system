 ...
 */
@WebServlet(name = "EditTimeOffRequest", urlPatterns = {"/EditTimeOffRequest"})
public class EditTimeOffRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            timeOffRequestBean.update(id, reason, begin, end, emp_id);
