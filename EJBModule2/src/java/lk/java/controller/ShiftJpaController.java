...
public class ShiftJpaController implements Serializable {
    ...
    public List<Shift> findByLocation(Location location) {

        EntityManager em = getEntityManager();
        return em.createNamedQuery("Shift.findByLocation").setParameter("location", location).getResultList();
    }

    public List<Shift> findByProject(Project project) {

        EntityManager em = getEntityManager();
        return em.createNamedQuery("Shift.findByProject").setParameter("project", project).getResultList();
    }

    public List<Shift> findByDeparment(Department department) {

        EntityManager em = getEntityManager();
        return em.createNamedQuery("Shift.findByDepartment").setParameter("department", department).getResultList();
    }

    public List<Shift> findByEmployee(Employee employee) {

        EntityManager em = getEntityManager();
        return em.createNamedQuery("Shift.findByEmployee").setParameter("employee", employee).getResultList();
    }
