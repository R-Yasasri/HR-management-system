...
@NamedQueries({
    ...
    , @NamedQuery(name = "Attendance.findByDate", query = "SELECT a FROM Attendance a WHERE SUBSTRING(a.clockIn,1,10) = :clockIn")//Added query
    , @NamedQuery(name = "Attendance.findByClockOut", query = "SELECT a FROM Attendance a WHERE a.clockOut = :clockOut")
    , @NamedQuery(name = "Attendance.findByShift", query = "SELECT a FROM Attendance a WHERE a.shiftIdshift = :shift")})// Added query
